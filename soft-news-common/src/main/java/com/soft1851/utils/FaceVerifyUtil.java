...
public class FaceVerifyUtil {
  ...
  static final Logger logger = LoggerFactory.getLogger(FaceVerifyUtil.class);
  ...
  public String sendPostVerifyFace(int type, String face1, String face2) throws Exception {
    ...
    //        String body = "{\"content_1\": \"" + face1 + "\", \"content_2\":\"" + face2 + "\",
    // \"type\":\"" + "1" + "\"}";
    ...
    try {
      ...
      String authHeader = "Dataplus " + "" + ":" + signature;
      // 打开和URL之间的连接
  ...
  public static void main(String[] args) {
    ...
    boolean result =
        new FaceVerifyUtil().faceVerify(FaceVerifyType.IMAGE_URL.type, face3, face4, 60);
